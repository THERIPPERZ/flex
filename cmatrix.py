...
tagadd = {
    ...
    "b": "บัญชีนี้ถูกป้องกันด้วย Self Bot STEVENEVERDIE ระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
                        ...
                        try:
                            if settings["autolike"] == True:
                                ...
                                if settings["com"] == True:
                                    ...
                                    data = {"type":"flex","altText":"AUTO LIKE","contents":{"styles":{"body":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FF0000"},"footer":{"backgroundColor":"#000000","separator":True,"separatorColor":"#FF0000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"image","url":"https://obs.line-scdn.net/{}".format(maxgie.getProfile().pictureStatus)},{"type":"separator","color":"#FF0000"},{"type":"image","url":"https://obs.line-scdn.net/{}".format(maxgie.getProfile().pictureStatus),"size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#FF0000"},{"contents":[{"contents":[{"text":"꧁༺ AUTOLIKE BY MAX ༻꧂","size":"sm","margin":"none","color":"#FFFF00","wrap":True,"weight":"regular","type":"text"}],"type":"box","layout":"baseline"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"md","layout":"vertical"},"footer":{"type":"box","layout":"vertical","contents":[{"type":"box","layout":"horizontal","flex":2,"contents":[{"type":"button","style":"secondary","color":"#FF0000","height":"sm","action":{"type":"uri","label":"ＣＲＥＡＴＯＲ","uri":"http://line.me/ti/p/%40jnx0914l"}}]}]}}}
                                    sendTemplate(op.param1,data)
                                else:
                                    pass
                        except Exception as e:
